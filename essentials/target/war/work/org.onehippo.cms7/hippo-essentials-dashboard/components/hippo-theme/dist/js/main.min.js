...
a.emptyOrMatch=function(a,b){return" "==b?!0:a.indexOf(b)>-1}}}})}(),/*
 * Copyright 2014-2015 Hippo B.V. (http://www.onehippo.com)
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
/**
         ...
         */
return a.getAll=function(){return b},a.setCurrent=function(a){angular.forEach(b,function(b){b.active=a.name==b.name})},a.getCurrent=function(){for(var a=0,c=b.length;c>a;a++)if(b[a].active===!0)return b[a]},a}]).directive("hippoViewportTest",["$window","hippoViewportSizes",function(a,b){return{restrict:"A",replace:!0,template:"<div></div>",link:function(c,d){
